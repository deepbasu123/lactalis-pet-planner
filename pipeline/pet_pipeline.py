...
Configuration (set as pipeline `configuration` keys):
    pet.catalog        default deep_test_1_catalog
    ...
    pet.volume_path    default /Volumes/deep_test_1_catalog/lactalis_pet_bronze/landing/uploads
...
CATALOG = spark.conf.get("pet.catalog", "deep_test_1_catalog")  # noqa: F821
...
VOLUME_PATH = spark.conf.get(  # noqa: F821
    "pet.volume_path",
    "/Volumes/deep_test_1_catalog/lactalis_pet_bronze/landing/uploads",
)
